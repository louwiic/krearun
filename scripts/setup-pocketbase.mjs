...
const collections = [
  {
    ...
    fields: [
      ...
      { name: "namePersonalizationPriceCents", type: "number", onlyInt: true },
      { name: "variants", type: "json" },
      { name: "quantityDiscounts", type: "json" },
      ...autodates,
    ],
  ...
  },
  {
    name: "newsletter",
    type: "base",
    fields: [{ name: "email", type: "text", required: true }, { name: "ignored", type: "bool" }, { name: "source", type: "text" }, ...autodates],
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "categories_json", type: "text", max: 10000 },
      {
        name: "homepage_mode",
        type: "select",
        maxSelect: 1,
        values: ["catalog", "single_product"],
      },
      { name: "homepage_featured_product_slug", type: "text" },
