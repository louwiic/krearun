...
export async function generateAddressLabelsPdf(labels: AddressLabel[]) {
  ...
  for (let pageIndex = 0; pageIndex < pageCount; pageIndex += 1) {
    ...
    for (const [index, lines] of fitted
